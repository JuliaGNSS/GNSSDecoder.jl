...
@testset "GPS L5I (CNAV)" begin
    ...
    function assert_spirent_golden(state)
        ...
        @test d.i_0_dot ≈ 9.9987573776161298e-11 * π
        ...
        @test d.ISC_L5I5 ≈ 0.0
        @test d.ISC_L5Q5 ≈ 0.0
        @test d.α0 ≈ 4.6566128730773926e-9
        @test d.α1 ≈ 1.4901161193847656e-8
        @test d.α2 ≈ -5.9604644775390625e-8
        @test d.α3 ≈ -5.9604644775390625e-8
        @test d.β0 ≈ 79872.0
        @test d.β1 ≈ 65536.0
        @test d.β2 ≈ -65536.0
        @test d.β3 ≈ -393216.0
